  ...
  return {
    ...
    async signIn() {
      update({
        ...
        auth: {
          status: "signed-in",
          viewer: { memberId: "member-preview-admin", displayName: "Sam Bodine", role: "admin" },
        },
      })
    },
    async signOut() {
