...
const OPENINGS = [
  {
    ...
    about: 'Work with a student team on our Fall 2026 engagement with Arc Thrift Stores of Colorado. You don’t need consulting or accessibility experience to apply. Disabled and non-disabled students from any undergraduate major are welcome.',
    doing: ['Research and analysis with the project managers.', 'Interviews with the client and the people it serves.', 'Weekly working sessions through the semester.', 'Present at the midpoint and the final review.'],
