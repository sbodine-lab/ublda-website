    ...
    <footer className="footer">
      <div className="container">
        <div className="footer__top">
          <div className="footer__brand">
            <span className="footer__logo">
              <img src="/logo.png" alt="" className="footer__logo-img" />
              UBLDA
            </span>
          ...
          <div className="footer__grid">
            ...
            <div className="footer__col">
              ...
              <a href="mailto:sbodine@umich.edu" className="footer__link">sbodine@umich.edu</a>
              <a href="mailto:atchiang@umich.edu" className="footer__link">atchiang@umich.edu</a>
              <a href="mailto:cooperry@umich.edu" className="footer__link">cooperry@umich.edu</a>
              <a href="https://www.instagram.com/ublda_umich/" target="_blank" rel="noopener noreferrer" className="footer__link footer__link--social">
        ...
        <div className="footer__bottom">
          <p>&copy; {new Date().getFullYear()} UBLDA. All rights reserved.</p>
